...
\textbf{Radiometric (Surface or Sky/Cloud-Base) Temperature ($^{\circ}C$):}\hypertarget{RSTx}{}\textbf{
...
\textbf{Radiometer Sensor Head Temperature ($^{\circ}C$):}\hypertarget{TRSTx}{}\textbf{
...
\textbf{Pyrgeometer Output (V):}\hypertarget{IRxV}{}\textbf{ }\textbf{\uline{IRxV}}\index{IRxV}\sindex[var]{IRXV}
\\
...
\textbf{Pyrgeometer Housing Temperature ($^{\circ}$C):}\hypertarget{IRxHT}{}\textbf{
...
\textbf{Pyranometer Output (V):}\hypertarget{VISxV}{}\textbf{ }\textbf{\uline{VISxV}}\index{VISxV}\sindex[var]{VISxV}\\
...
\textbf{Pyranometer Housing Temperature ($^{\circ}$C):}\hypertarget{VISxHT}{}\textbf{
...
\textbf{Calibrated Visible Irradiance (W~m$^{-2}$):}\hypertarget{VISxC}{}\textbf{
...
\textbf{Stabilized Platform Angles ($^{\circ}$):}\hypertarget{SPxPitch}{}\hypertarget{SPxRoll}{}\textbf{
...
\begin{hangparagraphs}
\textbf{Solar Declination Angle (radians):}\hypertarget{SOLAR}{}\textbf{
