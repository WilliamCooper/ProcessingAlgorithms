...
\textbf{Radiometer Sensor Head Temperature ($^{\circ}C$): }\textbf{\uline{TRSTx}}\sindex[var]{TRSTB, TRSTT}\index{TRSTB, TRSTT}\\
...
\textbf{Pyrgeometer Output (V): }\textbf{\uline{IRxV}}\index{IRxV}\sindex[var]{IRXV}
\\
...
\textbf{Pyrgeometer Housing Temperature ($^{\circ}$C): }\textbf{\uline{IRxHT}}\index{IRxHT}\sindex[var]{IRxHT}\\
...
\textbf{Pyranometer Output (V): }\textbf{\uline{VISxV}}\index{VISxV}\sindex[var]{VISxV}\\
...
\textbf{Pyranometer Housing Temperature ($^{\circ}$C): }\textbf{\uline{VISxHT}}\index{VISxHT}\sindex[var]{VISxHT}\\
...
\textbf{Calibrated Visible Irradiance (W~m$^{-2}$): }\textbf{\uline{VISxC}}\index{VISxC}\sindex[var]{VISxC}\\
...
\textbf{Stabilized Platform Angles ($^{\circ}$): SPxPitch,}\index{SPxPitch}\sindex[var]{SPxPitch}
\textbf{SPxRoll}\index{SPxRoll}\sindex[var]{SPxRoll}\\
