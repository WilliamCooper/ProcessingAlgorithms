...
\textbf{Latitude (}$\text{�}$\textbf{): }\textbf{\uline{LAT}}\sindex[var]{LAT}\index{LAT}\hypertarget{LAT}{}\\
...
\textbf{Longitude (}$\text{�}$\textbf{): }\textbf{\uline{LON}}\sindex[var]{LON}\textbf{\uline{\index{LON}}}\hypertarget{LON}{}\textbf{\uline{}}\\
...
\textbf{Aircraft True Heading (}$^{\circ}$\textbf{): }\textbf{\uline{THDG}}\index{THDG}\hypertarget{THDG}{}\\
...
\textbf{Aircraft Pitch Attitude Angle (}$\text{�}$\textbf{): }\textbf{\uline{PITCH}}\sindex[var]{PITCH}\index{PITCH}\index{INS!specifications}\hypertarget{PITCH}{}\\
...
\textbf{Aircraft Roll Attitude Angle (}$\text{�}$\textbf{): }\textbf{\uline{ROLL}}\sindex[var]{ROLL}\index{ROLL}\hypertarget{ROLL}{}\\
...
\textbf{Aircraft Vertical Acceleration (m\,s$^{-2}$): }\textbf{\uline{ACINS}}\sindex[var]{ACINS}\index{ACINS}\hypertarget{ACINS}{}\\
...
\textbf{Computed Aircraft Vertical Velocity (m/s): }\textbf{\uline{VSPD}}\sindex[var]{VSPD}\index{VSPD}\hypertarget{VSPD}{}\\
...
\textbf{Inertial Altitude (m): }\textbf{\uline{ALT}}\sindex[var]{ALT}\index{ALT}\hypertarget{ALT}{}\\
...
\textbf{Aircraft Ground Speed (m/s): }\textbf{\uline{GSF}}\sindex[var]{GSF}\index{GSF}\hypertarget{GSF}{}\\
...
\textbf{Aircraft Ground Speed East Component (m/s): }\textbf{\uline{VEW}}\sindex[var]{VEW}\index{VEW}\hypertarget{VEW}{}\\
...
\textbf{Aircraft Ground Speed North Component (m/s) }\textbf{\uline{VNS}}\sindex[var]{VNS}\index{VNS}\hypertarget{VNS}{}\\
...
\textbf{Distance East/North of a Reference (km): }\textbf{\uline{DEI}}\textbf{\sindex[var]{DEI}\index{DEI@DE\textbf{I}}/}\textbf{\uline{DNI}}\sindex[var]{DNI}\index{DNI}\hypertarget{DEI}{}\hypertarget{DNI}{}\\
...
}\textbf{\uline{FXDIST}}\sindex[var]{FXDIST}\index{FXDIST}\hypertarget{FXAZIM}{}\hypertarget{FXDIST}{}\\
...
\begin{hangparagraphs}
\textbf{Raw Lateral Body Acceleration (m/s$^{2}$): }\textbf{\uline{BLATA}}\sindex[var]{BLATA}\index{BLATA}\hypertarget{BLATA}{}\\
...
\textbf{Raw Longitudinal Body Acceleration (m/s$^{2}$): }\textbf{\uline{BLONA}}\sindex[var]{BLONA}\index{BLONA}\hypertarget{BLONA}{}\\
...
\textbf{Raw Normal Body Acceleration (m/s$^{2}$): }\textbf{\uline{BNORMA}}\sindex[var]{BNORMA}\index{BNORMA}\hypertarget{BNORMA}{}\\
...
\textbf{Raw Body Pitch Rate (}$\text{�}$\textbf{/s): }\textbf{\uline{BPITCHR}}\sindex[var]{BPITCHR}\index{BPITCHR}\hypertarget{BPITCHR}{}\\
...
\textbf{Raw Body Roll Rate (}$\text{�}$\textbf{/s): }\textbf{\uline{BROLLR}}\sindex[var]{BROLLR}\index{BROLLR}\hypertarget{BROLLR}{}\\
...
\textbf{Raw Body Yaw Rate (}$\text{�}$\textbf{/s): }\textbf{\uline{BYAWR}}\sindex[var]{BYAWR}\index{BYAWR}\hypertarget{BYAWR}{}\\
...
also formerly \textbf{\uline{GLAT\sindex[var]{GLAT} \index{GLAT}}}\hypertarget{GGLAT}{}\\
...
also formerly \textbf{\uline{GLON\sindex[var]{GLON}\index{GLON}}}\hypertarget{GGLON}{}\\
...
\textbf{\uline{GSF}}\textbf{\_}\textbf{\uline{G}}\textbf{\sindex[var]{GSF_G@GSF\_G}\index{GSF_G@GSF\_G}}\hypertarget{GGSPD}{}\\
...
\textbf{\uline{VEW\_G}}\sindex[var]{VEW_G@VEW\_G}\index{VEW_G@VEW\_G}\hypertarget{GGVEW}{}\\
...
\textbf{\uline{VNS\_G}}\uline{\sindex[var]{VNS_G@VNS\_G}\index{VNS_G@VNS\_G}}\hypertarget{GGVNS}{}\\
...
\textbf{GPS-Computed Aircraft Vertical Velocity (m/s):}\hypertarget{GGVSPD}{}\textbf{
...
\textbf{\uline{GALT\_A\sindex[var]{GALT_A@GALT\_A}\index{GALT_A@GALT\_A}}}\hypertarget{GGALT}{}\\
...
\textbf{GPS Aircraft Track Angle ($\text{�}$):}\hypertarget{GGTRK}{}\textbf{
...
\textbf{GPS Height of the Geoid (m):}\hypertarget{GGOIDHT}{}\textbf{
}\textbf{\uline{GGEOIDHT\sindex[var]{GGEOIDHT}\index{GGEOIDHT}}}\\
\emph{Height of geoid, approximating mean sea level, above the WGS84
ellipsoid.} \label{punch3.4}

\textbf{GPS Satellites Tracked:}\hypertarget{GGNSAT}{}\textbf{ }\textbf{\uline{GGNSAT}}\textbf{\sindex[var]{GGNSAT}\index{GGNSAT}}\\
\emph{The number of satellites tracked by a GPS unit.}

\textbf{GPS Mode:}\hypertarget{GGWUAL}{}\textbf{ }\textbf{\uline{GGQUAL}}\sindex[var]{GGQUAL}\index{GGQUAL}\\
...
\textbf{GPS Mode:}\hypertarget{GMODE}{}\textbf{ }\textbf{\uline{GMODE\sindex[var]{GMODE (obsolete)}\index{GMODE}
}}\emph{(obsolete)}\\
...
\textbf{GPS Status:}\hypertarget{GGSTATUS}{}\textbf{ }\textbf{\uline{GGSTATUS}}\sindex[var]{GGSTATUS}\index{GGSTATUS},
...
\begin{hangparagraphs}
\textbf{Geometric Radio Altitude (m):}\hypertarget{HGM}{}\textbf{
}\textbf{\uline{HGM}}\sindex[var]{HGM}\index{HGM} \emph{- (obsolete)}\\
...
\textbf{Geometric Radar Altitude (Extended Range) (APN-159) (m):}\hypertarget{HGME}{}\textbf{
...
\textbf{Geometric Radar Altitude (Extended Range) (APN-232) (m):}\hypertarget{HGM232}{}\textbf{
...
\textbf{Pressure-Damped Inertial Altitude (m):}\hypertarget{HI3}{}\textbf{
...
\textbf{ISA Pressure Altitude (m):}\hypertarget{PALT}{}\textbf{ }\textbf{\uline{PALT}}\sindex[var]{PALT}\index{PALT}\\
...
about 8\textendash 40 m over the altitude range of the GV.} A note at \href{http://wiki.eol.ucar.edu/rafscience/ProcessingAlgorithms?action=AttachFile&do=view&target=PressureAltitude.pdf}{this URL}
...
\begin{hangparagraphs}
\textbf{GPS-Corrected Inertial Ground Speed Vector, (m/s):}\hypertarget{VEWC}{}\hypertarget{VNSC}{}\textbf{
...
\textbf{GPS-Corrected Inertial Latitude and Longitude (}$\text{�}$\textbf{):}\hypertarget{}{LATC}\hypertarget{LONC}{}\textbf{
