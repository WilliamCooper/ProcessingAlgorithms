...
\textbf{GPS-Computed Aircraft Vertical Velocity (m/s): }\textbf{\uline{GGVSPD,
VSPD\_G\sindex[var]{VSPD_G@VSPD\_G}\index{VSPD_G@VSPD\_G}\sindex[var]{GGVSPD}\index{GGVSPD}}}\textbf{,}
...
\textbf{GPS Aircraft Track Angle ($\text{�}$): }\textbf{\uline{GGTRK\sindex[var]{GGTRK}\index{GGTRK}}}\textbf{,}\textbf{\uline{
...
\textbf{GPS Height of the Geoid (m): }\textbf{\uline{GGEOIDHT\sindex[var]{GGEOIDHT}\index{GGEOIDHT}}}\\
\emph{Height of geoid, approximating mean sea level, above the WGS84
ellipsoid.} \label{punch3.4}

\textbf{GPS Satellites Tracked: }\textbf{\uline{GGNSAT}}\textbf{\sindex[var]{GGNSAT}\index{GGNSAT}}\\
...
\textbf{GPS Mode: }\textbf{\uline{GMODE\sindex[var]{GMODE (obsolete)}\index{GMODE}
}}\emph{(obsolete)}\\
...
\textbf{Geometric Radar Altitude (Extended Range) (APN-159) (m): }\textbf{\uline{\label{HGME}HGME}}\sindex[var]{HGME}\index{HGME}\\
\emph{The distance to the surface below the aircraft, measured by
