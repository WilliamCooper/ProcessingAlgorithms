...
from \textminus 160 to 212 °F, referenced and used in the Smithsonian
Tables (List, 1980).} for saturation vapor pressure with respect to a plane ice surface.
...
and/or roll). (For more information, refer to \href{https://opensky.ucar.edu/islandora/object/archives\%3A6963}{RAF Bulletin 25}.)\index{Bulletin 25}\label{punch:10-5}
...
unless a correction is made. See \href{https://opensky.ucar.edu/islandora/object/archives\%3A8155}{RAF Bulletin 24}\index{Bulletin 24}
