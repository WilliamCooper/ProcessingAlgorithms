...
```
<p class=box>
$e=$\{[EWX](#ewx)\}$*100$ = water vapor pressure [Pa]  
[ATX](#ambient-t) = ambient temperature ($^{\circ}\mathrm{C}$)  
$r=$\{[MR](#MR)\}/1000.\index{MR} = mixing ratio (dimensionless)  
$p_{d}=$(\{[PSXC](#psx)\}$-$\{[EWX](#ewx)\})$*100$ = ambient dry-air pressure [Pa]  
$p_{0}=$reference pressure for potential temperature, 10$^{5}$Pa  
$\chi=$\{[PLWCC](./5-cloud-physics-variables.html#plwcc)\}/1000.=cloud liquid water content [kg$\,$m$^{-3}$]  
