...
#### GPS Aircraft Track Angle (º): GGTRK, TKAT_G, GTKAT_A  {#ggtrk .unnumbered}

*The direction of the aircraft track (degrees clockwise from true north)* as measured by a data-system global positioning system (GGTRK) or an avionics-system GPS (TKAT_G or GTKET_A).  
