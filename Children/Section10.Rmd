...
These variables are calculated from UI and VI, the east and north components of the wind determined as described in RAF Bulletin No. 23 and summarized in Section\ \@ref(wind):`r ToDoLink('10.1')`  
<p class=box2>
\begin{align}
