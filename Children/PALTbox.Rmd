...
$p$ = measured static (ambient) pressure, hPa, usually from [PSXC](#psx)  
$p_{0}^{\ddagger}$
 = 1013.25 hPa, reference pressure for PALT=0 $^{\ddagger}$  
...
to be equivalent to the following:</p>
```{r include = TRUE, echo = TRUE, eval = FALSE, results = 'asis', highlight=FALSE}
