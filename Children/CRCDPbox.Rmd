...
<p class=box>
[VCRH](#cryo-hygro) = frost point inside the cryogenic hygrometer [$^{\circ}$C]    
[CRHP](#cryo-hygro) = pressure inside the chamber of the cryogenic hygrometer [hPa]  
[PSXC](./4-the-state-of-the-atmosphere.html#psx) = reference ambient pressure [hPa]  
