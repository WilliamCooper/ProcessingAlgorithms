...
[VEW](#vew) ([VNS](#vns)) = eastward (northward) groundspeed of the aircraft (see
below)  
[LAT](#latitude) = latitude measured by the IRS [º]  
$C_{dr}=\pi/180^{\circ}$ = conversion factor, degrees to radians  
[PALT](#palt) = pressure altitude of the aircraft  
...
\ \ \ The following code segment uses "*acz*" for acceleration $a_{z}$. "deltaT" for time between updates,\
\ \ \ and "hx" and "hxx" to store the feedback terms:  
