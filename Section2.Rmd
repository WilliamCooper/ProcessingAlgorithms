...
Near the end of this technical note, there is a list of symbols.^[Some symbols used only once and defined where they are used are omitted from this list] <span id="punch0.1" label="punch0.1">[punch0.1, need symbol list]</span><span id="punch0.2" label="punch0.2">[punch0.2, need variable list]</span>
