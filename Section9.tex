...
\textbf{Mach Number (dimensionless):}\hypertarget{MACHx}{}\hypertarget{MACHX}{}\textbf{
...
\textbf{Aircraft True Airspeed (m/s):}\hypertarget{TASx}{}\hypertarget{TASxD}{}\hypertarget{TASX}{}\textbf{
...
\textbf{Aircraft True Airspeed (Humidity Corrected) (m/s):}\hypertarget{TASHC}{}\textbf{
...
\textbf{Attack Angle Differential Pressure (mb):}\hypertarget{ADIFR}{}\textbf{
...
\textbf{Sideslip Angle Differential Pressure (mb):}\hypertarget{BDIFR}{}\textbf{
...
\textbf{Attack Angle, Radome (}$\text{�}$\textbf{):}\hypertarget{AKRD}{}\textbf{
...
\textbf{Reference Sideslip Angle (}$\text{�}$\textbf{):}\hypertarget{SSLIP}{}\textbf{
...
\begin{hangparagraphs}
\textbf{Wind Vector East Component (m/s):}\hypertarget{UI}{}\textbf{
}\textbf{\uline{UI\sindex[var]{UI}\index{UI}}}

\textbf{Wind Vector North Component (m/s):}\hypertarget{VI}{}\textbf{
}\textbf{\uline{VI\sindex[var]{VI}\index{VI}}}

\textbf{Wind Vector Vertical Component (m/s):}\hypertarget{WI}{}\textbf{
...
\noindent\begin{minipage}[t]{1\columnwidth}%
\begin{hangparagraphs}
\textbf{Wind Speed (m/s):}\hypertarget{WS}{}\textbf{ }\textbf{\uline{WS}}\textbf{\sindex[var]{WS}\index{WS}}

\textbf{Wind Direction (}$\text{�}$\textbf{):}\hypertarget{WD}{}\textbf{
...
\noindent\begin{minipage}[t]{1\columnwidth}%
\begin{hangparagraphs}
\textbf{Wind Vector Longitudinal Component (m/s):}\hypertarget{UX}{}\textbf{
}\textbf{\uline{UX\sindex[var]{UX}\index{UX}}}

\textbf{Wind Vector Lateral Component (m/s):}\hypertarget{VY}{}\textbf{
}\textbf{\uline{VY}}\sindex[var]{VY}\index{VY}
\end{hangparagraphs}
...
\noindent\begin{minipage}[t]{1\columnwidth}%
\begin{hangparagraphs}
\textbf{GPS-Corrected Wind Vector, East Component (m/s):}\hypertarget{UIC}{}\textbf{
}\textbf{\uline{UIC\sindex[var]{UIC}\index{UIC}}}

\textbf{GPS-Corrected Wind Vector, North Component (m/s):}\hypertarget{VIC}{}\textbf{
...
\textbf{Wind Vector, Vertical Component (m/s):}\hypertarget{WIC}{}\textbf{
...
\noindent\begin{minipage}[t]{1\columnwidth}%
\begin{hangparagraphs}
\textbf{GPS-Corrected Wind Direction (}$^{\circ}$\textbf{):}\hypertarget{WDC}{}\textbf{
}\textbf{\uline{WDC}}\sindex[var]{WDC}\index{WDC}

\textbf{GPS-Corrected Wind Speed (m/s):}\hypertarget{WSC}{}\textbf{
}\textbf{\uline{WSC\sindex[var]{WSC}}}\index{WSC}
\end{hangparagraphs}
...
\noindent\begin{minipage}[t]{1\columnwidth}%
\begin{hangparagraphs}
\textbf{GPS-Corrected Wind Vector, Longitudinal Component (m/s):}\hypertarget{UXC}{}\textbf{
}\textbf{\uline{UXC}}\sindex[var]{UXC}\textbf{\uline{\index{UXC}}}

\textbf{GPS-Corrected Wind Vector, Lateral Component (m/s):}\hypertarget{VYC}{}\textbf{
