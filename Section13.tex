...
\textbf{Carbon Monoxide Preliminary Mixing Ratio (ppbv):}\nop{CORAW_AL}{}\textbf{
...
\textbf{Carbon Monoxide Mixing Ratio (ppbv):}\nop{COMR_AL}{}\textbf{
...
\textbf{Carbon Dioxide Mixing Ratio (ppmv):}\nop{CO2_PIC}{}\textbf{
...
cavity ring-down spectroscopy. The time resolution is 0.2 -- 1 seconds.
Additional information characterizing the instrument can be found
at \href{https://www.eol.ucar.edu/instruments/picarro-instrument-airborne-measurement-co2-and-ch4}{this URL}.
...
\noindent\begin{minipage}[t]{1\columnwidth}%
\textbf{Chemiluminescent Ozone Sample Flow Rate (sccm):}\nop{XFO3FS}{}\textbf{
}\textbf{\uline{XFO3FS}}\textbf{\index{XFO3FS}\sindex[var]{XFO3FS}}\\
\textbf{Chemiluminescent Ozone Nitric Oxide Flow Rate (sccm):}\nop{XFO3FNO}{}\textbf{
}\textbf{\uline{XFO3FN}}\textbf{O\index{XFO3FNO}\sindex[var]{XFO3FNO}}\\
\textbf{Chemiluminescent Ozone Sample Pressure (mb):}\nop{XFO3P}{}\textbf{
...
}142--148. }, and there is additional information describing the instrument at
...
\textbf{Uncorrected TECO Ozone Mixing Ratio (ppb):}\nop{TEO3}{}\textbf{
...
\noindent\begin{minipage}[t]{1\columnwidth}%
\textbf{Internal TECO Ozone Sampling Pressure (hPa):}\nop{TEP}{}\nop{TEO3P}{}\textbf{
}\textbf{\uline{TEP}}\textbf{\index{TEP}\sindex[var]{TEP}, }\textbf{\uline{TEO3P}}\index{TEO3P}\sindex[var]{TEO3P}\\
\textbf{Internal TECO Ozone Sampling Temperature ($^{\circ}C$):}\nop{TET}{}\textbf{
...
\textbf{Corrected TECO Ozone Mixing Ratio (ppbv):}\nop{TEO3C}{}\textbf{
...
\textbf{}%
\noindent\begin{minipage}[t]{1\columnwidth}%
\textbf{NO Raw Counts (counts per sample interval):}\nop{XNO}{}\textbf{
}\textbf{\uline{XNO}}\textbf{\index{XNO}}\sindex[var]{XNO}\textbf{}\\
\textbf{NOy Raw Counts (counts per sample interval):}\nop{XNOY}{}\textbf{
}\textbf{\uline{XNOY\index{XNOY}}}\sindex[var]{XNOY}\textbf{\uline{}}\\
\textbf{NO Calibration Flow (SLPM):}\nop{XNOCF}{}\textbf{ }\textbf{\uline{XNOCF}}\textbf{\index{XNOCF}}\sindex[var]{XNOCF}\textbf{}\\
\textbf{NOy Calibration Flow (SLPM):}\nop{XNCLF}{}\textbf{ }\textbf{\uline{XNCLF}}\textbf{\index{XNCLF}}\sindex[var]{XNCLF}\textbf{}\\
\textbf{NO, NOy Measurement Status (dimensionless):}\nop{XNST}{}\textbf{
}\textbf{\uline{XNST}}\textbf{\index{XNST}}\sindex[var]{XNST}\textbf{}\\
\textbf{NO Zero Air Flow (SLPM):}\nop{XNOZA}{}\textbf{ }\textbf{\uline{XNOZA}}\textbf{\index{XNOZA}}\sindex[var]{XNOZA}\textbf{}\\
\textbf{NOy Zero Air Flow (SLPM):}\nop{XNZAF}{}\textbf{ }\textbf{\uline{XNZAF}}\textbf{\index{XNZAF}}\sindex[var]{XNZAF}\textbf{}\\
\textbf{NO Sample Flow (SLPM):}\nop{XNOSF}{}\textbf{ }\textbf{\uline{XNOSF}}\textbf{\index{XNOSF}}\sindex[var]{XNOSF}\textbf{}\\
\textbf{NOy Sample Flow (SLPM):}\nop{XNSAF}{}\textbf{ }\textbf{\uline{XNSAF}}\textbf{\index{XNSAF}}\sindex[var]{XNSAF}\textbf{}\\
\textbf{NOy Reaction Chamber Pressure (mb):}\nop{XNOYP}{}\textbf{
}\textbf{\uline{XNOYP}}\textbf{\index{XNOYP}}\sindex[var]{XNOYP}\textbf{}\\
\textbf{Gold NOy Converter Temperature ($\text{º}$C):}\nop{XNMBT}{}\textbf{
...
\noindent\begin{minipage}[t]{1\columnwidth}%
C\textbf{orrected NO Mixing Ratio (ppbv):}\nop{XNOCAL}{}\textbf{
}\textbf{\uline{XNOCAL}}\textbf{\index{XNOCAL}}\\
\textbf{Corrected NO$_{2}$ Mixing Ratio (ppbv):}\nop{XNYCAL}{}\textbf{
...
Users interested in using these measurements should contact \href{mailto:mailto:raf-dm\%40eol.ucar.edu}{EOL/RAF data management}
