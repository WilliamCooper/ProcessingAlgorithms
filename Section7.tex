...
\textbf{Static Pressure (hPa):}\hypertarget{PSxC}{}\hypertarget{PSXC}{}\hypertarget{PSx}{}\hypertarget{PSX}{}\hypertarget{PS_A}{}\hypertarget{PSFD}{}\hypertarget{PSFRD}{}\textbf{
...
\textbf{Dynamic Pressure (hPa):}\hypertarget{QCx}{}\hypertarget{QCxC}{}\hypertarget{QCX}{}\hypertarget{QCXC}{}\textbf{
...
\textbf{D-Value (m):}\hypertarget{DVALUE}{}\textbf{ }\textbf{\uline{DVALUE}}\textbf{\index{DVALUE}}\sindex[var]{DVALUE}\\
...
\textbf{Special Pressure Measurements (hPa):}\hypertarget{PSDPx}{}\hypertarget{CAVP_x}{}\hypertarget{PCAB}{}\hypertarget{PSURF}{}\textbf{
...
\begin{hangparagraphs}
\textbf{\label{RTx discussion}Recovery Temperature ($\text{�}$C):}\hypertarget{RTx}{}\hypertarget{RTxH}{}\hypertarget{RTHRx}{}\hypertarget{RTX}{}\textbf{
...
\textbf{Ambient Temperature ($^{\circ}$C):}\hypertarget{ATx}{}\hypertarget{ATX}{}\hypertarget{ATxJ}{}\hypertarget{ATxD}{}\textbf{
...
\textbf{In-cloud Air Temperature, Radiometric ($^{\circ}$C):}\hypertarget{AT_ITR}{}
...
\textbf{Ophir Air Temperature ($^{\circ}$C):}\hypertarget{OAT}{}\textbf{
...
\begin{hangparagraphs}
\textbf{Dew/Frost Point ($\text{�}$C):}\hypertarget{DPx}{}\hypertarget{DP_x}{}\hypertarget{MIRRTMP_DPX}{}\textbf{
...
\textbf{Corrected Dew Point (C):}\hypertarget{DPxC}{}\hypertarget{DPXC}{}\textbf{
...
\textbf{Dew Point Determined from the VCSEL Hygrometer ($^{\circ}$C):}\hypertarget{DP_VXL}{}\textbf{
...
($^{\circ}$C):}\hypertarget{FP_CR2}{}\hypertarget{MIRRORT_CR2}{}\textbf{
}\textbf{\uline{FP\_CR2\sindex[var]{FP_CR2@FP\_CR2}\index{FP_CR2@FP\_CR2}}}\textbf{,}\\
...
($^{\circ}$C):}\hypertarget{DP_CR2C}{}\textbf{ }\textbf{\uline{DP\_CR2C}}\index{DP_CR2C@DP\_CR2C}\sindex[var]{DP_CR2C@DP\_CR2C}\\
...
(molecules cm$^{-3}$):}\hypertarget{RAWCONC_VXL}{}\textbf{ }\textbf{\uline{RAWCONC\_VXL}}\index{RAWCONC_VXL@RAWCONC\_VXL}\sindex[var]{RAWCONC_VXL@RAWCONC\_VXL}
\emph{}\\
...
(molecules cm$^{-3}$):}\hypertarget{CONCV_VXL}{}\textbf{ }\textbf{\uline{CONCV\_VXL}}\uline{:}\index{CONCV_VXL@CONCV\_VXL}\sindex[var]{CONCV_VXL@CONCV\_VXL}\\
...
\textbf{Voltage Output from the UV Hygrometer (V):}\hypertarget{XSIGV_UHV}{}\textbf{
...
cm$^{-3}$):}\hypertarget{CONCH_UVH}{}\textbf{ }\textbf{\uline{CONCH\_UVH}}\index{CONCH_UVH@CONCH\_UVH}\sindex[var]{CONCH_UVH@CONCH\_UVH}\\
...
\textbf{Water Vapor Pressure (hPa):}\hypertarget{EWx}{}\hypertarget{EWX}{}\hypertarget{EW_UHV}{}\hypertarget{EDPC}{}\textbf{
...
\textbf{Relative Humidity (per cent or Pa/hPa):}\hypertarget{RHUM}{}\textbf{
...
\textbf{Relative Humidity with respect to Ice (per cent or Pa/hPa):}\hypertarget{RHUMI}{}\textbf{
...
\textbf{Absolute Humidity, Water Vapor Density (g/m$^{3}$):}\hypertarget{RHOx}{}\textbf{
...
\textbf{Specific Humidity (g/kg):}\hypertarget{SPHUM}{}\textbf{ }\textbf{\uline{SPHUM}}\sindex[var]{SPHUM}\index{SPHUM}\\
...
\textbf{Mixing Ratio (g/kg):}\hypertarget{MR}{}\hypertarget{MRCR}{}\hypertarget{MRLA}{}\hypertarget{MRLH}{}\hypertarget{MRVCL}{}\textbf{
...
\begin{hangparagraphs}
\textbf{Potential Temperature (K):}\hypertarget{THETA}{}\textbf{
}\textbf{\uline{THETA}}\sindex[var]{THETA}\index{THETA}\\
...
\textbf{Pseudo-Adiabatic Equivalent Potential Temperature (K):}\hypertarget{THETAP}{}\hypertarget{THETAE}{}\textbf{
...
\textbf{Virtual Temperature ($\text{�}$C):}\hypertarget{TVIR}{}\textbf{
...
\textbf{Virtual Potential Temperature (K):}\hypertarget{THETAV}{}\textbf{
...
\textbf{Wet-Equivalent Potential Temperature (K):}\hypertarget{THETAQ}{}\textbf{
